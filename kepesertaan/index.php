                ...
                <div id="nav_bar" class="row" style="margin: 0px 0px 0px 0px; ">
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        <ul class="nav navbar-nav box-info">
                            ...
                            <li class="active" style="background-color: #EBF4FA;"><a href=""><b>KEPESERTAAN</b></a></li>
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="box box-info">
                          <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="tab-content no-padding">
                                    <div style="width:100%; height:560px;" id="pertumbuhan_jenis_kelamin"></div>
                                </div>
                            </div>                        
                          </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="box box-info">
                          <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="tab-content no-padding">
                                    <div style="width:100%; height:560px;" id="pertumbuhan_kepemilikan_nik"></div>
                                </div>
                            </div>                        
                          </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="box box-info">
                          <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="tab-content no-padding">
                                    <div style="width:100%; height:560px;" id="pertumbuhan_tidak_aktif"></div>
                                </div>
                            </div>                        
                          </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-xs-12">
                        <div class="box box-info">
                          <div class="row">
                            <div class="col-lg-12 col-xs-12">
                                <div class="tab-content no-padding">
                                    <div style="width:100%; height:560px;" id="pertumbuhan_kelas_perawatan"></div>
                                </div>
                            </div>                        
                          </div>
                        </div>
