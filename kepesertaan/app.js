$(function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data['success']) {
                    ...
                    load_detail('ppu', periode['id'], propinsi, kabupaten);
                    ...
                    if(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')) {
                    ...
                    peta_cakupan.title.update({ text: 'Cakupan Kepesertaan'+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?' Tahun ':' Bulan '+periode['bulan']+' ') + periode['tahun'] });
                    ...
                    chart_proporsi_pusat_jamkesda_ppu_pbpu_bp.title.update({ text: 'Proporsi Kepesertaan Berdasarkan Segmen Kepesertaan Sampai Dengan Bulan '+periode['bulan']+' '+periode['tahun'] });
                    ...
                    label_total_peserta = chart_jeniskelamin_all.renderer.label("Total: "+totalpeserta+' Jiwa')
                    .css({
                        width: '250px',
                        color: '#333',
                        fontWeight: 'bold',
                    ...
                    chart_jeniskelamin_all.title.update({ text: 'Kepesertaan Berdasarkan<br />Jenis Kelamin Bulan '+(periode_jk['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_jk['bulan']+' '+periode_jk['tahun']+(periode_jk['id']!=periode['id']?'</span>':'') });
                    ...
                    for(var key in data_jeniskelamin) {
                        if(eval(data_jeniskelamin[key]['laki_laki'])>0 || eval(data_jeniskelamin[key]['perempuan'])>0) {
                            ...
                            data_jeniskelamin_1[i] = {y: eval(data_jeniskelamin[key]['laki_laki']), label: 'Laki-laki: '+data_jeniskelamin[key]['laki_laki_view']};
                            data_jeniskelamin_2[i] = {y: eval(data_jeniskelamin[key]['perempuan']), label: 'Perempuan: '+data_jeniskelamin[key]['perempuan_view']};
                        }
                    }

                    chart_jeniskelamin_pbi_non_pbi.title.update({ text: 'Kepesertaan PBI dan Non PBI<br/>Berdasarkan Jenis Kelamin Bulan '+(periode_jk['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_jk['bulan']+' '+periode_jk['tahun']+(periode_jk['id']!=periode['id']?'</span>':'') });
                    ...
                    for(var key in data_jeniskelamin) {
                        if(eval(data_jeniskelamin[key]['laki_laki'])>0 || eval(data_jeniskelamin[key]['perempuan'])>0) {
                            ...
                            data_jeniskelamin_1[i] = {y: eval(data_jeniskelamin[key]['laki_laki']), label: 'Laki-laki: '+data_jeniskelamin[key]['laki_laki_view'], percentage: persentase_laki_laki};
                            data_jeniskelamin_2[i] = {y: eval(data_jeniskelamin[key]['perempuan']), label: 'Perempuan: '+data_jeniskelamin[key]['perempuan_view'], percentage: persentase_perempuan};
                        }
                    }

                    jeniskelamin_pusat_jamkesda_ppu_pbpu_bp.title.update({ text: 'Kepeserta PBI Pusat, Jamkesda, PPU, PBPU, dan BP<br />Berdasarkan Jenis Kelamin Bulan '+(periode_jk['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_jk['bulan']+' '+periode_jk['tahun']+(periode_jk['id']!=periode['id']?'</span>':'') });
                    jeniskelamin_pusat_jamkesda_ppu_pbpu_bp.xAxis[0].setCategories(arr, true, true);
                    
                    jeniskelamin_pusat_jamkesda_ppu_pbpu_bp.series[1].setData(data_jeniskelamin_2);
                    jeniskelamin_pusat_jamkesda_ppu_pbpu_bp.series[0].setData(data_jeniskelamin_1);
                    ...
                    jeniskelamin_ppu.title.update({ text: 'Kepeserta PPU Berdasarkan<br />Jenis Kelamin Bulan '+(periode_jk['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_jk['bulan']+' '+periode_jk['tahun']+(periode_jk['id']!=periode['id']?'</span>':'') });
                    jeniskelamin_ppu.xAxis[0].setCategories(arr, true, true);
                    
                    jeniskelamin_ppu.series[0].setData(data_jeniskelamin_1);
                    jeniskelamin_ppu.series[1].setData(data_jeniskelamin_2);
                    ...
                    label_total_peserta = chart_nik_all.renderer.label("Total: "+totalpeserta+' Jiwa')
                    .css({
                        width: '250px',
                        color: '#333',
                        fontWeight: 'bold',
                    ...
                    chart_nik_all.title.update({ text: 'Identitas Peserta Bulan '+(periode_nik['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_nik['bulan']+' '+periode_nik['tahun']+(periode_nik['id']!=periode['id']?'</span>':'') });
                    ...
                    for(var key in data_nik) {
                        if(eval(data_nik[key]['dengan_nik'])>0 || eval(data_nik[key]['tanpa_nik'])>0) {
                            ...
                            data_nik_1[i] = {y: eval(data_nik[key]['dengan_nik']), label: 'Dilengkapi dengan NIK: '+data_nik[key]['dengan_nik_view']};
                            data_nik_2[i] = {y: eval(data_nik[key]['tanpa_nik']), label: 'Tanpa NIK: '+data_nik[key]['tanpa_nik_view']};
                        }
                    }

                    chart_nik_pbi_non_pbi.title.update({ text: 'Identitas Peserta PBI dan Non PBI<br/>Bulan '+(periode_nik['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_nik['bulan']+' '+periode_nik['tahun']+(periode_nik['id']!=periode['id']?'</span>':'') });
                    ...
                    for(var key in data_nik) {
                        if(eval(data_nik[key]['dengan_nik'])>0 || eval(data_nik[key]['tanpa_nik'])>0) {
                            ...
                            data_nik_1[i] = {y: eval(data_nik[key]['dengan_nik']), label: 'Dilengkapi dengan NIK: '+data_nik[key]['dengan_nik_view'], percentage: persentase_dengan_nik};
                            data_nik_2[i] = {y: eval(data_nik[key]['tanpa_nik']), label: 'Tanpa NIK: '+data_nik[key]['tanpa_nik_view'], percentage: persentase_tanpa_nik};
                        }
                    }

                    nik_pusat_jamkesda_ppu_pbpu_bp.title.update({ text: 'Identitas Peserta PBI Pusat, Jamkesda, PPU, PBPU, dan BP<br />Bulan '+(periode_nik['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_nik['bulan']+' '+periode_nik['tahun']+(periode_nik['id']!=periode['id']?'</span>':'') });
                    ...
                    nik_ppu.title.update({ text: 'Identitas Peserta PPU<br />Bulan '+(periode_nik['id']!=periode['id']?'<span class="blink" style="color: red;">':'')+periode_nik['bulan']+' '+periode_nik['tahun']+(periode_nik['id']!=periode['id']?'</span>':'') });
                    ...
                    label_pertumbuhan_all = chart_pertumbuhan_jumlah_peserta.renderer.label("Pertumbuhan"+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Rata-rata":"")+": "+ summary['pertumbuhan']+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %"))
                    .css({
                        width: '370px',
                        color: '#333',
                        //backgroundColor: 'red',
                    ...
                    chart_pertumbuhan_jumlah_peserta.title.update({ text: "Pertumbuhan Jumlah Peserta" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    ...
                    label_pertumbuhan_pbi_non_pbi = chart_pertumbuhan_pbi_non_pbi.renderer.label('<table><tr><td colspan="2" height="25px" valign="top">Perkembangan'+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Rata-rata":"")+':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /></td></tr><tr><td>PBI:</td><td align="right">'+pertumbuhan_rata_rata_pbi+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr><tr><td>Non PBI:&nbsp;&nbsp;&nbsp;</td><td align="right">'+pertumbuhan_rata_rata_non_pbi+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr></table>', null, null, null, null, null, true)
                    .css({
                        width: '310px',
                        color: '#333',
                        fontWeight: 'bold',
                    ...
                    chart_pertumbuhan_pbi_non_pbi.title.update({ text: "Perkembangan Jumlah Peserta PBI dan non PBI" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    ...
                    label_pertumbuhan_pbi_pusat_jamkesda_ppu_pbpu_bp = chart_pertumbuhan_pusat_jamkesda_ppu_pbpu_bp.renderer.label(
                            '<table><tr><td colspan="5" height="25px" valign="top">Perkembangan'+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Rata-rata":"")+':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>' +
                            '<tr><td>PBI Pusat:</td><td align="right">'+pertumbuhan_rata_rata_pbi_pusat+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td> <td width="170px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>PBPU:&nbsp;&nbsp;</td><td align="right">'+pertumbuhan_rata_rata_pbpu+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr>'+
                            '<tr><td>PBI Jamkesda:&nbsp;&nbsp;</td><td align="right">'+pertumbuhan_rata_rata_jamkesda+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td> <td width="170px">&nbsp;</td><td>BP:</td><td align="right">'+pertumbuhan_rata_rata_bp+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr>'+
                            '<tr><td>PPU:&nbsp;&nbsp;</td><td align="right">'+pertumbuhan_rata_rata_ppu+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td> <td width="170px">&nbsp;</td><td></td><td align="right"></td></tr></table>', null, null, null, null, null, true)
                    .css({
                        width: '810px',
                        color: '#333',
                        fontWeight: 'bold',
                    ...
                    chart_pertumbuhan_pusat_jamkesda_ppu_pbpu_bp.title.update({ text: "Perkembangan Jumlah Peserta " +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    ...
                    label_pertumbuhan_ppu = chart_pertumbuhan_ppu.renderer.label(
                            '<table><tr><td colspan="5" height="25px" valign="top">Perkembangan'+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Rata-rata":"")+':&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>' +
                            '<tr><td>PPU Pemerintah:&nbsp;&nbsp;</td><td align="right">'+pertumbuhan_rata_rata_pemerintah+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr>'+
                            '<tr><td>PPU Swasta:</td><td align="right">'+pertumbuhan_rata_rata_swasta+(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" jiwa":" %")+'</td></tr></table>', null, null, null, null, null, true)
                    .css({
                        width: '810px',
                        color: '#333',
                        fontWeight: 'bold',
                    ...
                    chart_pertumbuhan_ppu.title.update({ text: "Perkembangan Jumlah Peserta PPU Pemerintah dan Swasta" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    ...
                    var arr = [];
                    var data_timeline = [];
                    data_timeline['laki_laki'] = [];
                    data_timeline['perempuan'] = [];
                    var topics = data['pertumbuhan_jenis_kelamin'];
                    var min_jumlah = 0;
                    for(var key in topics) {
                        if(key==0) {
                            min_jumlah = eval(topics[key]['jumlah_laki_laki'])<eval(topics[key]['jumlah_perempuan'])?eval(topics[key]['jumlah_laki_laki']):eval(topics[key]['jumlah_perempuan']);
                        }
                        arr[key] = topics[key]['periode'];
                        data_timeline['laki_laki'][key] = {y: eval(topics[key]['jumlah_laki_laki']), label: topics[key]['view_jumlah_laki_laki']};
                        data_timeline['perempuan'][key] = {y: eval(topics[key]['jumlah_perempuan']), label: topics[key]['view_jumlah_perempuan']};
                        
                        min_jumlah = (eval(topics[key]['jumlah_laki_laki'])<eval(topics[key]['jumlah_perempuan'])?eval(topics[key]['jumlah_laki_laki']):eval(topics[key]['jumlah_perempuan']))<min_jumlah?(eval(topics[key]['jumlah_laki_laki'])<eval(topics[key]['jumlah_perempuan'])?eval(topics[key]['jumlah_laki_laki']):eval(topics[key]['jumlah_perempuan'])):min_jumlah;
                    }

                    while(eval(chart_pertumbuhan_jenis_kelamin.series.length) > 0) {
                        chart_pertumbuhan_jenis_kelamin.series[0].remove(true);
                    }
                    
                    chart_pertumbuhan_jenis_kelamin.addSeries({                        
                        name: 'Laki-Laki',
                        color: '#00279C',
                        data: data_timeline['laki_laki']
                    }, false);

                    chart_pertumbuhan_jenis_kelamin.addSeries({
                        name: 'Perempuan',
                        color: '#AF00AF',
                        data: data_timeline['perempuan']
                    }, false);

                    //chart_pertumbuhan_jenis_kelamin.yAxis[0].setExtremes(min_jumlah, null);
                    chart_pertumbuhan_jenis_kelamin.title.update({ text: "Perkembangan Jumlah Peserta Berdasarkan Jenis Kelamin" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    chart_pertumbuhan_jenis_kelamin.xAxis[0].setCategories(arr, true, true);
                    chart_pertumbuhan_jenis_kelamin.redraw();
                    
                    //PERKEMBANGAN KEPEMILIKAN NIK
                    var arr = [];
                    var data_timeline = [];
                    data_timeline['dengan_nik'] = [];
                    data_timeline['tanpa_nik'] = [];
                    var topics = data['pertumbuhan_kepemilikan_nik'];
                    var min_jumlah = 0;
                    for(var key in topics) {
                        if(key==0) {
                            min_jumlah = eval(topics[key]['jumlah_dengan_nik'])<eval(topics[key]['jumlah_tanpa_nik'])?eval(topics[key]['jumlah_dengan_nik']):eval(topics[key]['jumlah_tanpa_nik']);
                        }
                        arr[key] = topics[key]['periode'];
                        data_timeline['dengan_nik'][key] = {y: eval(topics[key]['jumlah_dengan_nik']), label: topics[key]['view_jumlah_dengan_nik']};
                        data_timeline['tanpa_nik'][key] = {y: eval(topics[key]['jumlah_tanpa_nik']), label: topics[key]['view_jumlah_tanpa_nik']};
                        
                        min_jumlah = (eval(topics[key]['jumlah_dengan_nik'])<eval(topics[key]['jumlah_tanpa_nik'])?eval(topics[key]['jumlah_dengan_nik']):eval(topics[key]['jumlah_tanpa_nik']))<min_jumlah?(eval(topics[key]['jumlah_dengan_nik'])<eval(topics[key]['jumlah_tanpa_nik'])?eval(topics[key]['jumlah_dengan_nik']):eval(topics[key]['jumlah_tanpa_nik'])):min_jumlah;
                    }

                    while(eval(chart_pertumbuhan_kepemilikan_nik.series.length) > 0) {
                        chart_pertumbuhan_kepemilikan_nik.series[0].remove(true);
                    }
                    
                    chart_pertumbuhan_kepemilikan_nik.addSeries({                        
                        name: 'Dengan NIK',
                        color: '#00279C',
                        data: data_timeline['dengan_nik']
                    }, false);

                    chart_pertumbuhan_kepemilikan_nik.addSeries({
                        name: 'Tanpa NIK',
                        color: '#808080',
                        data: data_timeline['tanpa_nik']
                    }, false);

                    //chart_pertumbuhan_kepemilikan_nik.yAxis[0].setExtremes(min_jumlah, null);
                    chart_pertumbuhan_kepemilikan_nik.title.update({ text: "Perkembangan Jumlah Peserta Kepemilikan NIK" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    chart_pertumbuhan_kepemilikan_nik.xAxis[0].setCategories(arr, true, true);
                    chart_pertumbuhan_kepemilikan_nik.redraw();
                    
                    //PERKEMBANGAN AKTIF dan TIDAK AKTIF
                    var arr = [];
                    var data_timeline = [];
                    data_timeline['aktif'] = [];
                    data_timeline['tidak_aktif'] = [];
                    var topics = data['pertumbuhan_tidak_aktif'];
                    var min_jumlah = 0;
                    for(var key in topics) {
                        if(key==0) {
                            min_jumlah = eval(topics[key]['jumlah_aktif'])<eval(topics[key]['jumlah_tidak_aktif'])?eval(topics[key]['jumlah_aktif']):eval(topics[key]['jumlah_tidak_aktif']);
                        }
                        arr[key] = topics[key]['periode'];
                        data_timeline['aktif'][key] = {y: eval(topics[key]['jumlah_aktif']), label: topics[key]['view_jumlah_aktif']};
                        data_timeline['tidak_aktif'][key] = {y: eval(topics[key]['jumlah_tidak_aktif']), label: topics[key]['view_jumlah_tidak_aktif']};
                        
                        min_jumlah = (eval(topics[key]['jumlah_aktif'])<eval(topics[key]['jumlah_tidak_aktif'])?eval(topics[key]['jumlah_aktif']):eval(topics[key]['jumlah_tidak_aktif']))<min_jumlah?(eval(topics[key]['jumlah_aktif'])<eval(topics[key]['jumlah_tidak_aktif'])?eval(topics[key]['jumlah_aktif']):eval(topics[key]['jumlah_tidak_aktif'])):min_jumlah;
                    }

                    while(eval(chart_pertumbuhan_tidak_aktif.series.length) > 0) {
                        chart_pertumbuhan_tidak_aktif.series[0].remove(true);
                    }
                    
                    chart_pertumbuhan_tidak_aktif.addSeries({                        
                        name: 'Aktif',
                        color: '#FF0000',
                        data: data_timeline['aktif']
                    }, false);

                    chart_pertumbuhan_tidak_aktif.addSeries({
                        name: 'Tidak Aktif',
                        color: '#0000FF',
                        data: data_timeline['tidak_aktif']
                    }, false);

                    //chart_pertumbuhan_tidak_aktif.yAxis[0].setExtremes(min_jumlah, null);
                    chart_pertumbuhan_tidak_aktif.title.update({ text: "Perkembangan Jumlah Peserta Aktif dan Tidak Aktif" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    chart_pertumbuhan_tidak_aktif.xAxis[0].setCategories(arr, true, true);
                    chart_pertumbuhan_tidak_aktif.redraw();
                    
                    
                    //PERKEMBANGAN KELAS PERAWATAN
                    var arr = [];
                    var data_timeline = [];
                    data_timeline['kelas_satu'] = [];
                    data_timeline['kelas_dua'] = [];
                    data_timeline['kelas_tiga'] = [];
                    var topics = data['pertumbuhan_kelas_perawatan'];
                    for(var key in topics) {
                        arr[key] = topics[key]['periode'];
                        data_timeline['kelas_satu'][key] = {y: eval(topics[key]['jumlah_kelas_1']), label: topics[key]['view_jumlah_kelas_1']};
                        data_timeline['kelas_dua'][key] = {y: eval(topics[key]['jumlah_kelas_2']), label: topics[key]['view_jumlah_kelas_2']};
                        data_timeline['kelas_tiga'][key] = {y: eval(topics[key]['jumlah_kelas_3']), label: topics[key]['view_jumlah_kelas_3']};
                    }

                    while(eval(chart_pertumbuhan_kelas_perawatan.series.length) > 0) {
                        chart_pertumbuhan_kelas_perawatan.series[0].remove(true);
                    }
                    
                    chart_pertumbuhan_kelas_perawatan.addSeries({                        
                        name: 'Kelas Satu',
                        color: '#FF0000',
                        data: data_timeline['kelas_satu']
                    }, false);

                    chart_pertumbuhan_kelas_perawatan.addSeries({
                        name: 'Kelas Dua',
                        color: '#0000FF',
                        data: data_timeline['kelas_dua']
                    }, false);

                    chart_pertumbuhan_kelas_perawatan.addSeries({
                        name: 'Kelas Tiga',
                        color: '#008000',
                        data: data_timeline['kelas_tiga']
                    }, false);

                    chart_pertumbuhan_kelas_perawatan.title.update({ text: "Perkembangan Jumlah Peserta Kelas Perawatan" +(($('#select_bulan').val()==0 || $('#select_bulan').val()==null || $('#select_bulan').val()=='')?" Tahun ":" Sampai Dengan Bulan "+periode['bulan']+" ") + periode['tahun'] });
                    chart_pertumbuhan_kelas_perawatan.xAxis[0].setCategories(arr, true, true);
                    chart_pertumbuhan_kelas_perawatan.redraw();
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data['success']) {
                    ...
                    chart_proporsi_ppu.title.update({ text: 'Profil Peserta Penerima Upah (PPU)<br />Sampai Dengan Bulan '+periode['bulan']+' '+periode['tahun'] });
    ...
    var chart_proporsi_pbi_non_pbi = new Highcharts.Chart({
        ...
        title: {
            text: 'Proporsi Kepesertaan PBI dan Non PBI',
            align: 'left'
        },
        subtitle: {
            text: ' ',
    ...
    var chart_proporsi_pusat_jamkesda_ppu_pbpu_bp = new Highcharts.Chart({
        ...
        title: {
            text: 'Proporsi Kepesertaan Berdasarkan Segmen Kepesertaan',
            align: 'center'
        },
        subtitle: {
            style: {
    ...
    var chart_proporsi_ppu = new Highcharts.Chart({
        ...
        title: {
            text: 'Profil Peserta Penerima Upah (PPU)',
            align: 'center'
        },
        subtitle: {
            style: {
    ...
    var chart_jeniskelamin_all = new Highcharts.Chart({
        ...
        tooltip: {
            pointFormat: '<b>{point.label}</b><br /><b>({point.percentage:.1f} %)</b>'
        },
        plotOptions: {
            pie: {
                allowPointSelect: true,
...
//    });
    ...
    var chart_pertumbuhan_pusat_jamkesda_ppu_pbpu_bp = new Highcharts.Chart({ 
        ...
        title: {
            text: 'Perkembangan Peserta PBI Pusat, Jamkesda, PPU, PBPU, dan BP',
            align: 'center'
        },
        subtitle: {
            style: {
    ...
    var chart_pertumbuhan_jenis_kelamin = new Highcharts.Chart({ 
        credits: {
            enabled: false
        },
        chart: {
            ...
            plotShadow: false,
            type: 'column',
            renderTo: 'pertumbuhan_jenis_kelamin'
        },
        title: {
            text: 'Perkembangan Jumlah Peserta Berdasarkan Jenis Kelamin',
            align: 'center'
        },
        subtitle: {
            style: {
    ...
    var chart_pertumbuhan_kepemilikan_nik = new Highcharts.Chart({ 
        credits: {
            enabled: false
        },
        chart: {
            ...
            plotShadow: false,
            type: 'column',
            renderTo: 'pertumbuhan_kepemilikan_nik'
        },
        title: {
            text: 'Perkembangan Jumlah Peserta Kepemilikan NIK',
            align: 'center'
        },
        subtitle: {
            style: {
    ...
    var chart_pertumbuhan_tidak_aktif = new Highcharts.Chart({ 
        credits: {
            enabled: false
        },
        chart: {
            ...
            plotShadow: false,
            type: 'column',
            renderTo: 'pertumbuhan_tidak_aktif'
        },
        title: {
            text: 'Pertubuhan Jumlah Peserta Aktif dan Tidak Aktif',
            align: 'center'
        },        
        subtitle: {
            style: {
    ...
    var chart_pertumbuhan_kelas_perawatan = new Highcharts.Chart({ 
        credits: {
            enabled: false
        },
        chart: {
            ...
            plotShadow: false,
            type: 'column',
            renderTo: 'pertumbuhan_kelas_perawatan'
        },
        title: {
            text: 'Perkembangan Jumlah Peserta Kelas Perawatan',
            align: 'center'
        },
        subtitle: {
            style: {
